...
#define FAIL                                                                   \
  ...
  auto ops_array = std::array{
      +[](u64 l, u64 r) -> u64 { return l + r; },
      +[](u64 l, u64 r) -> u64 { return l - r; },
      +[](u64 l, u64 r) -> u64 { return l * r; },
      +[](u64 l, u64 r) -> u64 { return l / r; },
      +[](u64 l, u64 r) -> u64 { return l % r; },
      +[](u64 l, u64 r) -> u64 { 
        u64 result = i32(l) < i32(r);
        // fprintf(stderr, "wiithin binop: %d < % d = %llu\n", (i32)l, (i32)r, result);
        return i32(l) < i32(r); },
      +[](u64 l, u64 r) -> u64 { return i32(l) <= i32(r); },
      +[](u64 l, u64 r) -> u64 { return i32(l) >  i32(r); },
      +[](u64 l, u64 r) -> u64 { return i32(l) >= i32(r); },
      +[](u64 l, u64 r) -> u64 { return i32(l) == i32(r); },
      +[](u64 l, u64 r) -> u64 { return i32(l) != i32(r); },
  ...
  u64 const LOCAL =  2;
  u64 const ARG = 3;
  auto create_reference = [&](u64 index, u64 kind) -> u64 {
    return (index << 2) | kind;
  };
  auto write_reference = [&](u64 reference, u64 value) -> void {
    u64 index = reference >> 2;
    u64 kind = reference & 0b11;
    if (kind == GLOBAL) {
      globals[index] = value;
    } else if (kind == LOCAL) {
